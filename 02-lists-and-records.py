...
def _():
    ...
    tax = input("how much tax did you pay")
    total_cost1 = float(cost) + float(tax)
    return cost, total_cost1


@app.cell
def _(cost, total_cost1):
    print(cost)
    print(f'The total cost is. ${total_cost1}')
    return
...
def _(freight_charges):
    for charge in freight_charges:
        ...
        total_cost2 = charge + freight_tax
        print(f'Total charge is ${total_cost2:.2f}')
    return
